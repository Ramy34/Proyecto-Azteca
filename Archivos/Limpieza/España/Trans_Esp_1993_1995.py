...
#Variables globales
pais = "España"
ruta_entrada = "Bronze//" + pais + "/Primera Division/Tipo 1"
...
def Trans_Esp_1993_1995():
    #Inicio del Proceso
    print("Se comienza con el proceso de limpieza y transformación de la liga española en el periodo de 1993 a 1995")
    ...
    df_combinado['Goles Medio Tiempo Visitante'] = df_combinado['Goles Visitante']
    df_combinado['Resultado Medio Tiempo'] = df_combinado['Resultado']
